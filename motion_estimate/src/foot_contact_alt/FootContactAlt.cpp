...
FootContactAlt::FootContactAlt(bool _log_data_files, const float schmitt_level){
  ...
  left_contact_state_strong_  = new SchmittTrigger(schmitt_level-150.0, schmitt_level+25.0, 100000, 100000);
  right_contact_state_strong_ = new SchmittTrigger(schmitt_level-150.0, schmitt_level+25.0, 100000, 100000);
