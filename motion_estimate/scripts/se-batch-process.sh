...
path=$HOME
path+="/val1-walking-lcm-logs/"
path_out=$HOME
path_out+='/Desktop/results6-all/'

unset files
files[0]='test' 
files=(
       'Valkyrie_100QuickSteps_NoArms-raw'
       'Valkyrie_NiceRunOverCinderBlocks_NoArms-raw'
       'Valkyrie_NiceStepsOperatorInterface_NoArms-raw'
       'Valkyrie_OK_Sidesteps-raw'
       'Valkyrie_TenNiceShortSteps-raw'
       #'Valkyrie_TenNiceShortSteps-filtered'
       #'Valkyrie_100QuickSteps_NoArms-filtered'
       #'Valkyrie_NiceRunOverCinderBlocks_NoArms-filtered'
       #'Valkyrie_NiceStepsOperatorInterface_NoArms-filtered'
       #'Valkyrie_OK_Sidesteps-filtered'
      )
...
process_log(){
  ...
  se-fusion       -U /valkyrie/V1_sim_shells_reduced_polygon_count_mit.urdf -P val_sim_scs_val1/robot.cfg -L $log_in -pr 0    -l $log_out_fusion
