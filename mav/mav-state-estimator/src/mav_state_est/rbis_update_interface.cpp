...
const char * RBISUpdateInterface::sensor_enum_chars = "igvlfsorxdukepap";
const char * RBISUpdateInterface::sensor_enum_strings[] =
    { "ins", "gps", "vicon", "laser", "laser_gpf", "scan_matcher", "optic_flow", "reset", "invalid", "rgbd", "fovis", "legodo", "legodo_external", "pose_meas", "altimeter", "airspeed", "sideslip" };
