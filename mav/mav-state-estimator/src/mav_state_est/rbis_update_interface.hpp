...
public:
  typedef enum {
    ins, gps, vicon, laser, laser_gpf, scan_matcher, optical_flow, reset, invalid, rgbd, fovis, legodo, legodo_external, pose_meas, altimeter, airspeed, sideslip, init_message
  } sensor_enum;
