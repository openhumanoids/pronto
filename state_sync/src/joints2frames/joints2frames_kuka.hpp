...
class joints2frames{
  ...
  private:
    ...
    void urdf_handler(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const  pronto::robot_urdf_t* msg);
    void robot_state_handler(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const  pronto::robot_state_t* msg);
