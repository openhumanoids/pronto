...
void state_sync::enableEncoderHandler(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const  pronto::utime_t* msg) {
...
void state_sync::multisenseHandler(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const  pronto::multisense_state_t* msg){ // multisense::state_t is the same as pronto::multisense_state_t
  ...
  if (cl_cfg_->standalone_head){
    pronto::force_torque_t force_torque_msg;
    publishRobotState(msg->utime, force_torque_msg);
  }
  
}

void state_sync::leftHandHandler(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const  pronto::hand_state_t* msg){
...
void state_sync::rightHandHandler(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const  pronto::hand_state_t* msg){
...
void state_sync::atlasHandler(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const  pronto::atlas_state_t* msg){
...
void state_sync::atlasExtraHandler(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const  pronto::atlas_state_extra_t* msg){
...
bool state_sync::insertPoseInRobotState(pronto::robot_state_t& msg, PoseT pose){
...
void state_sync::publishRobotState(int64_t utime_in,  const  pronto::force_torque_t& force_torque_msg){
...
void state_sync::appendJoints(pronto::robot_state_t& msg_out, Joints joints){
