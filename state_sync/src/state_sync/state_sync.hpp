...
class state_sync{
  ...
  private:
    ...
    void atlasHandler(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const  pronto::atlas_state_t* msg);
    void leftHandHandler(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const  pronto::hand_state_t* msg);
    void rightHandHandler(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const  pronto::hand_state_t* msg);
    ...
    void atlasExtraHandler(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const  pronto::atlas_state_extra_t* msg);
    
    void enableEncoderHandler(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const  pronto::utime_t* msg);
    ...
    void publishRobotState(int64_t utime_in, const  pronto::force_torque_t& msg);
    void appendJoints(pronto::robot_state_t& msg_out, Joints joints);
    
    bool insertPoseInRobotState(pronto::robot_state_t& msg, PoseT pose);
};    
